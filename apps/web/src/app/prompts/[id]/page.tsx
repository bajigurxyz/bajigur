...
import { ApiError, fetchCatalogEntry, formatUsdc, type PublicCatalogEntry } from "@/lib/api";
...
export default function PromptDetailPage() {
  ...
  const load: LoadState = loaded?.forId === id ? loaded.state : { phase: "pending" };
      ...
      <main className="mx-auto max-w-5xl px-4 pt-8 pb-24 sm:px-6">
        ...
        {load.phase === "not-found" && (
          <div className="rounded-2xl border border-gray-200 px-6 py-20 text-center">
            <h1 className="mb-2 text-2xl font-normal tracking-tight">Prompt not found</h1>
            <p className="mb-6 text-sm text-gray-600">
              Nothing in the catalog answers to “{id}”. It may have been removed, or the link is
              wrong.
            </p>
            <Link
              href="/prompts"
        ...
        {load.phase === "error" && (
          <div role="alert" className="rounded-2xl border border-gray-200 px-6 py-20 text-center">
            ...
            <p className="mb-6 text-sm text-gray-600">
              The Promit API isn&apos;t reachable right now. Try again in a moment.
            </p>
            <Link
              href="/prompts"
      ...
      <div className="flex flex-col gap-4">
        ...
        {paid && (
          <p className="flex items-center gap-1.5 text-xs text-gray-500">
            ...
            The preview you&apos;re watching was generated by running this exact prompt.
          </p>
        )}
