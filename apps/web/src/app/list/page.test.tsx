...
const BODY_TEXT = "Design a neon-lit signup flow for a night-market app. Use bold gradients.";
...
describe("halaman /list — alur submit", () => {
  ...
  it("personal_sign menerima pesan kanonik ber-hash dari prepare, dan kirimannya memuat tanda tangan", async () => {
    ...
    const [hexMessage, signer] = (signCall![0] as unknown as { params: [string, string] }).params;
  ...
  it("field yang belum lengkap ditolak sebelum wallet atau jaringan disentuh", async () => {
    ...
    expect(
      screen.getByText(
        // Copy now names both routes to a preview, since a link is accepted too.
